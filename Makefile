...
test: $(TARGET) $(TEST_STEP1_TARGET) $(TEST_TOKENIZER_TARGET) $(TEST_PARSER_TARGET) $(TEST_STUDENT_STORAGE_TARGET) $(TEST_STEP4_TARGET)
	./$(TEST_STEP1_TARGET)
...
clean:
	rm -f $(TARGET) $(TEST_STEP1_TARGET) $(TEST_TOKENIZER_TARGET) $(TEST_PARSER_TARGET) $(TEST_STUDENT_STORAGE_TARGET) $(TEST_STEP4_TARGET)
